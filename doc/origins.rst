...
:Authors: Karl Norby <knorby@uchicago.edu>
:Date: Tues, 5 Sept. 2006
:Description: A description of the origins of pyXSD

pyXSD was authored by Karl Norby while on working at Oak Ridge National Laboratory
...
Karl's mentors that summer were Thomas Schulthess, Michael Summers, and Paul Kent.
Karl was working in the `Computational Materials Science Group`_, which is in the
...
Paul Kent assisted Karl with the approach to the transforms that he wrote for
the group. Michael Summers came up with the technical approach to the program.
He and Karl are the program's co-authors.
...
project and the pyXSD website are maintained by Karl Norby.
